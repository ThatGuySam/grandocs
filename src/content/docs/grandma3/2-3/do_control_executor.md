---
title: "Executor Elements"
description: "Executors are used to playback and control elements of a show file in an accessible way. For example, they can be used to control a sequence."
product: grandma3
version: "2.3"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.3/HTML/do_control_executor.html"
scrapedAt: "2026-06-15T18:24:52.496Z"
pagefind: false
---
...
For more information about executors, see the [Executors topic](/grandma3/2-3/executor/).

Objects can be assigned to executors via the user interface of the grandMA3 software. The following menu/window gives access to the executor:

- To open the Playbacks window, in the [Add Window pop-up](/grandma3/2-3/wvm_add_window/) tap Common and Playbacks.
- To open the Playbacks menu, press F5 on the keyboard or tap ![](/img/grandma3/2-3/icon_master-fader_24_v1-0-ed81e4.png) in the control bar.
...
![](/img/grandma3/2-3/button_exec_v0-99_1-72c3a5.png)

_Executor location on large consoles_
...
The executors 191 thru 198 are located as the lower row of Xkeys (X9 to X16 | Exec). For more information see [Keys](/grandma3/2-3/keys/).
...
The executors 291 thru 298 are located as the upper row of Xkeys (X1 | Clone to X8 | DMX). For more information see [Keys](/grandma3/2-3/keys/).
