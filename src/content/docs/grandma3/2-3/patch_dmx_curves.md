...
version: "2.3"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.3/HTML/patch_dmx_curves.html"
scrapedAt: "2026-06-15T18:25:20.965Z"
pagefind: false
---
...
![](/img/grandma3/2-3/menu_patch_dmx-curves_v2-2-431ab2.png)
...
The curves can be assigned to parameters in the [Parameter List](/grandma3/2-3/patch_parameter_list/). This applies the curve to a specific DMX channel.
...
DMX Curves can be assigned to an attribute in a [Fixture Type](/grandma3/2-3/fixture_types/). This applies the curve to the selected attribute for all the fixtures of this type.
