---
title: "Classes and Layers"
description: "Fixtures can be organized and grouped in both Class and Layer."
product: grandma3
version: "2.3"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.3/HTML/patch_classes_layers.html"
scrapedAt: "2026-06-15T18:25:20.657Z"
pagefind: false
---
...
The class and/or layer can be used when applying [filters in the patch](/grandma3/2-3/patch_add_fixtures/#filter).
...
Classes and layers can be assigned to fixtures in the [patch menu](/grandma3/2-3/patch_add_fixtures/) when it is in **Full** column mode or when the **Split View** is active in layers or classes.
