...
description: "Tapping a free space on a screen opens the Add Window pop-up. The tapped grid field is used as the upper left corner of the created window. From here, the windo"
product: grandma3
version: "2.3"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.3/HTML/wvm_rearrange.html"
scrapedAt: "2026-06-15T18:25:17.846Z"
pagefind: false
---
Tapping a free space on a screen opens the [Add Window](/grandma3/2-3/wvm_add_window/) pop-up. The tapped grid field is used as the upper left corner of the created window. From here, the window takes all the available space it can and becomes as big as possible, trying to fill all available space on the screen.

Tap, hold, and drag on an empty screen to draw a square. Releasing the screen opens the [Add Window](/grandma3/2-3/wvm_add_window/) pop-up, and the selected window fills the drawn square.

The window size can often be made smaller.

In the lower right corner of each window, there is a small resize corner: ![](/img/grandma3/2-3/img_resize-corner_v0-1-d37248.png)
