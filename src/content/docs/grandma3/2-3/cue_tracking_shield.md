...
version: "2.3"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.3/HTML/cue_tracking_shield.html"
scrapedAt: "2026-06-15T18:25:24.700Z"
pagefind: false
---
...
![Tracking Shield Example 1 - Sequence Starting Point](/img/grandma3/2-3/img_tracking-shield_example_start-sequence_v2-1-c07031.png)
...
![Store Pop-up](/img/grandma3/2-3/popup_store-cue_merge_v2-3-f23792.png)
...
![Tracking Shield Example - Result using "Off" option](/img/grandma3/2-3/img_tracking-shield_example_shield-off_v2-1-6516f0.png)
...
![Tracking Shield Example - Result using "From Zero" option](/img/grandma3/2-3/img_tracking-shield_example_shield-from-zero_v2-1-4db37f.png)
...
![Tracking Shield Example 2 - Sequence Starting Point](/img/grandma3/2-3/img_tracking-shield_example-2_start-sequence_v2-1-e09a28.png)
...
![Tracking Shield Example 2 - Result using "Off" and "From Zero" option](/img/grandma3/2-3/img_tracking-shield_example-2_shield-off_v2-1-ce32ab.png)
...
![Tracking Shield Example 2 - Result using "Above Zero" option](/img/grandma3/2-3/img_tracking-shield_example-2_shield-above-zero_v2-1-0f3182.png)
