...
version: "2.3"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.3/HTML/qsg_group.html"
scrapedAt: "2026-06-15T18:25:40.690Z"
pagefind: false
---
...
![](/img/grandma3/2-3/qsg_06_group-pool_empty_v2-1-49a916.png)
...
The group does not have a name, but we can label the group easily. The last thing we touch or click gets focus. This is indicated with a white frame. When a pool object has focus, and we start writing on our keyboard, the system assumes we are giving it a label.
...
Pool objects have a special **Swipey** menu that gives access to some standard functions. The menu is accessed by clicking and holding the group and then moving the pointer out of the group pool object.

![](/img/grandma3/2-3/qsg_06_swipey-menu_v2-3-fa3ab9.png)
...
The last group is fixtures 22, 23, 26, 29, 32, and 33 - label this group "Odd Blinders".
...
Groups are described in detail in the [Groups section](/grandma3/2-3/group/) of the main manual.

The [next chapter](/grandma3/2-3/qsg_appear/) is about appearance.
