...
version: "2.3"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.3/HTML/macro_variables.html"
scrapedAt: "2026-06-15T18:25:27.059Z"
pagefind: false
---
...
Creating a variable is the same whether it is a user or global variable, but we use two different keywords to set one or the other: [SetGlobalVariable](/grandma3/2-3/keyword_setglobalvariable/) or [SetUserVariable](/grandma3/2-3/keyword_setuservariable/).
...
|                                                                    |                                                        |
| ------------------------------------------------------------------ | ------------------------------------------------------ |
| ![](/img/grandma3/2-3/icon_commandline-input_logo_v2-0-59d23e.png) | User name\[Fixture]>SetUserVariable MyFavoriteNumber 9 |

|                                                                    |                                                        |
| ------------------------------------------------------------------ | ------------------------------------------------------ |
| ![](/img/grandma3/2-3/icon_commandline-input_logo_v2-0-59d23e.png) | User name\[Fixture]>SetUserVariable MyFavoriteText "9" |
...
|                                                                    |                                                                          |
| ------------------------------------------------------------------ | ------------------------------------------------------------------------ |
| ![](/img/grandma3/2-3/icon_commandline-input_logo_v2-0-59d23e.png) | User name\[Fixture]>SetUserVariable MySpecialGroup "Group 'Spots Grid' " |
...
|                                                                    |                                           |
| ------------------------------------------------------------------ | ----------------------------------------- |
| ![](/img/grandma3/2-3/icon_commandline-input_logo_v2-0-59d23e.png) | User name\[Fixture]>$MySpecialGroup At 80 |
...
The variables' content and type can be listed using the [GetGlobalVariable](/grandma3/2-3/keyword_getglobalvariable/) or [GetUserVariable](/grandma3/2-3/keyword_getuservariable/) keywords.
...
These commands show information about the variable name, content type, and content in the [Command Line Feedback window](/grandma3/2-3/ws_ui_command_line/).
...
The [asterisk (\*)](/grandma3/2-3/keyword_asterisk/) wildcard can show all variables or a filtered list of variables for which a part of the name is known.
...
|                                                                    |                                                    |
| ------------------------------------------------------------------ | -------------------------------------------------- |
| ![](/img/grandma3/2-3/icon_commandline-input_logo_v2-0-59d23e.png) | User name\[Fixture]>GetUserVariable MySpecialGroup |
...
|                                                                    |                                            |
| ------------------------------------------------------------------ | ------------------------------------------ |
| ![](/img/grandma3/2-3/icon_commandline-input_logo_v2-0-59d23e.png) | User name\[Fixture]>GetUserVariable \*ur\* |
...
|                                                                    |                                           |
| ------------------------------------------------------------------ | ----------------------------------------- |
| ![](/img/grandma3/2-3/icon_commandline-input_logo_v2-0-59d23e.png) | User name\[Fixture]>GetUserVariable Our\* |

This example shows all the user variables:

|                                                                    |                                        |
| ------------------------------------------------------------------ | -------------------------------------- |
| ![](/img/grandma3/2-3/icon_commandline-input_logo_v2-0-59d23e.png) | User name\[Fixture]>GetUserVariable \* |
...
|                                                                    |                                                              |
| ------------------------------------------------------------------ | ------------------------------------------------------------ |
| ![](/img/grandma3/2-3/icon_commandline-input_logo_v2-0-59d23e.png) | User name\[Fixture]>SetUserVariable MyGroupName "Spots Grid" |

Now, this variable can be used where the text would be used otherwise:

|                                                                    |                                                |
| ------------------------------------------------------------------ | ---------------------------------------------- |
| ![](/img/grandma3/2-3/icon_commandline-input_logo_v2-0-59d23e.png) | User name\[Fixture]>Group $"MyGroupName" At 80 |
