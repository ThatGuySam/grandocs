...
version: "2.3"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.3/HTML/rdm.html"
scrapedAt: "2026-06-15T18:25:38.214Z"
pagefind: false
---
...
- Press Menu - Network: Enable the RDM button in the **[Stations](/grandma3/2-3/network_session/#h3_1753514110) **tab.
- Or Press Menu - Network: Enable the RDM button in the **[Station Control](/grandma3/2-3/network_station_control/)** tab. 
...
![](/img/grandma3/2-3/window_device_rdm_v2-1-377e3c.png)

Tap Mode A and change it to RDM. Confirm the changes by tapping Apply. The background color of the port turns to turquoise: 

![Connector Configuration options with Port A in RDM mode and RDM activated globally in the bottom right.](/img/grandma3/2-3/menu_output_config_rdm_v2-1-fea804.png)
...
Open the RDM devices window via the [Add Window](/grandma3/2-3/wvm_add_window/) dialog in the Tools tab.
...
[![](/img/grandma3/2-3/robot-icon_white-274940.png)       Paste to Command Line](#ma_cmd?Store%20ScreenContent%20Default%20%22WindowRDM%22%20%2FAutoFit)
...
![RDM devices window with RDMPorts in expanded mode. ](/img/grandma3/2-3/menu_rdm_devices_v2-1-0d61d1.png)
...
Expanding with ![](/img/grandma3/2-3/triangle_right_15_1-d9ca8a.png) next to the RDM fixture shows all the different parameters of the fixture:

![RDM devices window with one active RDM fixture in a expanded view.](/img/grandma3/2-3/window_rdm_devices_v2-1-d5fbd2.png)
...
|                                            | The RDM devices window also displays all Parameters individual commands under a specific column called [Command](/grandma3/2-3/rdm/#h2__469026232).   |
