...
version: "2.3"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.3/HTML/shf_organize.html"
scrapedAt: "2026-06-15T18:24:54.499Z"
pagefind: false
---
## Show File History
...
- Date: This shows the date and time when the show file was saved.
...
- UTC: This shows the date and time in UTC time.
...
![Show file name with description and time stamp](/img/grandma3/2-3/window_backup_show_history_v1-9-9ab6f8.png)
...
|                                            | When you create a new show file with kept show segments, the defined show segments are displayed in the Description area. For more information, see [New Show File](/grandma3/2-3/sfh_new/). |

![Backup Menu New Show](/img/grandma3/2-3/description_line_backup_menu_v2-2-40e1ea.png)
...
![Backup Menu](/img/grandma3/2-3/menu_description_v2-1-e9ccd0.png)
...
- Enumerating a show file can also be called with the /Enumerate option. For more information see [/Enumerate option keyword](/grandma3/2-3/ok_enumerate/).
