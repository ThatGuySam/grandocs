---
title: "/Path"
description: "To enter the /Path option keyword in the command line, use one of the options:"
product: grandma3
version: "2.3"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.3/HTML/ok_path.html"
scrapedAt: "2026-06-15T18:25:16.407Z"
pagefind: false
---
...
- [SaveShow keyword](/grandma3/2-3/keyword_saveshow/)
...
|                                                                    |                                                                            |
| ------------------------------------------------------------------ | -------------------------------------------------------------------------- |
| ![](/img/grandma3/2-3/icon_commandline-input_logo_v2-0-59d23e.png) | User name\[Fixture]>Export Macro 1 "test" If Drive 2 /Path "/myfavorites"  |
...
|                                                                    |                                                                   |
| ------------------------------------------------------------------ | ----------------------------------------------------------------- |
| ![](/img/grandma3/2-3/icon_commandline-input_logo_v2-0-59d23e.png) | User name\[Fixture]>LoadShow "Fabulous" If Drive 2 /Path "/test"  |
