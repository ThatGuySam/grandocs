...
description: "Please refer to the system requirements topic to learn more about the computer specifications."
product: grandma3
version: "2.3"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.3/HTML/onpc_optimize_windows.html"
scrapedAt: "2026-06-15T18:24:54.063Z"
pagefind: false
---
|                                            |                                                                                                              |
| ------------------------------------------ | ------------------------------------------------------------------------------------------------------------ |
| ![](/img/grandma3/2-3/tip_gray-269535.png) | **Hint:**                                                                                                    |
|                                            | The grandMA3 onPC software is available for Windows™® and [macOS®](/grandma3/2-3/onpc_macos_installation/).  |

Please refer to the [system requirements topic](/grandma3/2-3/onpc_system_requirements/) to learn more about the computer specifications.

For more information about the grandMA3 onPC app, the terminal app, and the different version icons, read the [Installation of grandMA3 onPC topic](/grandma3/2-3/onpc_windows_installation/).
...
![](/img/grandma3/2-3/img_power_options_v1-1-340133.png)
...
![](/img/grandma3/2-3/img_power_options2_v1-1-a5e786.png)

2. For **Turn off the display**, choose Never.
3. For **Put the computer to sleep**, choose Never.

![](/img/grandma3/2-3/img_power_options3_v1-1-d653cb.png)

4. Click Save changes.

5) Click Change advance power settings.

![](/img/grandma3/2-3/img_power_options4_v1-1-64bfb8.png)
...
![](/img/grandma3/2-3/img_power_options5_v1-1-9a3cd2.png)
...
To suppress the system requirement pop-up, enable the Do not show this message again checkbox and then tap Yes.
...
![Update this description text.](/img/grandma3/2-3/popup_windows_requirements-e663de.png)

System Requirement Warning

An error pop-up may appear when starting the grandMA3 onPC software.

![Update this description text.](/img/grandma3/2-3/popup_windows_requirements_error_v2-2-12caff.png)
