...
version: "2.3"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.3/HTML/patch_parameter_list.html"
scrapedAt: "2026-06-15T18:25:20.956Z"
pagefind: false
---
The Patch menu gives access to the list of all the parameters by tapping the Parameter List button in the menu on the left of the [Patch Menu](/grandma3/2-3/patch/).

These parameters are also called RTChannels (Realtime Channels).

This menu lists all the parameters in the show.

![](/img/grandma3/2-3/menu_parameter-list_v2-3-e8661a.png)
...
- **DMX Curve**:\
  This field can be used to select one of the existing DMX curves. Learn about DMX curves in the [DMX Curve topic](/grandma3/2-3/patch_dmx_curves/).
...
It is done using the [Default](/grandma3/2-3/keyword_default/), [Highlight](/grandma3/2-3/keyword_highlight/), and [Lowlight](/grandma3/2-3/keyword_lowlight/) keywords and the [/Remove](/grandma3/2-3/ok_remove/) and [/Merge](/grandma3/2-3/ok_merge/) option keywords.
