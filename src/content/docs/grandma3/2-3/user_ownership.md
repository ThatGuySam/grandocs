...
version: "2.3"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.3/HTML/user_ownership.html"
scrapedAt: "2026-06-15T18:25:19.854Z"
pagefind: false
---
...
![](/img/grandma3/2-3/img_pool-object_locked-by-other-user_v2-2-e77bde.png)
...
![](/img/grandma3/2-3/img_pool-object_partially_locked-by-other-user_v2-2-c7ef9a.png)
...
![](/img/grandma3/2-3/popup_ownership-conflict_v1-9-e84fd5.png)
...
A user can try to get ownership of a temporarily locked object using the [DropOwnership keyword](/grandma3/2-3/keyword_dropownership/).

This presents a pop-up at the stations belonging to the user who owns the object:

![](/img/grandma3/2-3/popup_drop-ownership_v1-9-5b101d.png)
...
The [ListOwnership keyword](/grandma3/2-3/keyword_listownership/) can list all or specific ownerships in a session. The result is shown in the [Command Line History window](/grandma3/2-3/ws_ui_command_line/).
