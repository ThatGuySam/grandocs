...
version: "2.3"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.3/HTML/lua_objectfree_cmdindirectwait.html"
scrapedAt: "2026-06-15T18:25:29.439Z"
pagefind: false
---
## Description
...
- **Handle** (optional):\
  A handle to an undo (oops) list. Learn more in the [CreateUndo](/grandma3/2-3/lua_objectfree_createundo/) topic.
- **Handle** (optional):\
...
This example prints "1" and "2" in the Command Line History and lets the main task open the [Configure Display pop-up](/grandma3/2-3/ws_ui_display_configuration/) on screen 2.
