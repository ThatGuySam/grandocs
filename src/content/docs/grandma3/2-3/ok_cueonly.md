---
title: "/CueOnly"
description: "To enter the /CueOnly option keyword in the command line, use one of the options:"
product: grandma3
version: "2.3"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.3/HTML/ok_cueonly.html"
scrapedAt: "2026-06-15T18:25:14.363Z"
pagefind: false
---
...
For more information see [Store Cues](/grandma3/2-3/cue_store/) and [Store Settings and Store Preferences](/grandma3/2-3/cue_store_settings_preferences/). 
...
- [Delete keyword](/grandma3/2-3/keyword_delete/)
...
|                                                                    |                                           |
| ------------------------------------------------------------------ | ----------------------------------------- |
| ![](/img/grandma3/2-3/icon_commandline-input_logo_v2-0-59d23e.png) | User name\[Fixture]>Store Cue 8 /CueOnly  |

- To store the current programmer values in cue 6 and release the recently stored dimmer values in the next cue, type:

|                                                                    |                                                       |
| ------------------------------------------------------------------ | ----------------------------------------------------- |
| ![](/img/grandma3/2-3/icon_commandline-input_logo_v2-0-59d23e.png) | User name\[Fixture]>Store Cue 6 /CueOnly "DimmerOnly" |

- To store the current programmer values in cue 5 and set the dimmer attributes to default values in the next cue, type:

|                                                                    |                                                                 |
| ------------------------------------------------------------------ | --------------------------------------------------------------- |
| ![](/img/grandma3/2-3/icon_commandline-input_logo_v2-0-59d23e.png) | User name\[Fixture]>Store Cue 5 /CueOnly "DimmerOnlyDefaultNew" |
