...
version: "2.3"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.3/HTML/patch_stage.html"
scrapedAt: "2026-06-15T18:25:20.652Z"
pagefind: false
---
In grandMA3 there are virtual stages. The fixtures [added to the patch](/grandma3/2-3/patch_add_fixtures/) are placed in a stage. The fixtures can be [positioned](/grandma3/2-3/patch_position_fixtures/) in this 3D virtual stage.
...
![](/img/grandma3/2-3/menu_patch_stages_v2-2-663c02.png)

_Stages menu with two stages_

The stages can be named for organizational purposes. Tags can be assigned to a stage.
...
|                                                  | Fixtures are patched inside stages. Deleting a stage also deletes all the fixtures in that stage, including all the information programmed about those fixtures.  |
...
![](/img/grandma3/2-3/menu_edit-stage_v2-2-79af33.png)
...
A stage space defines a volume in the stage. This space is relevant when using XYZ programming. It defines the size of the space the fixtures can point to. Read more about this in the [XYZ section](/grandma3/2-3/xyz/).
...
Adding MArker fixtures automatically adds stage spaces for Target and, if needed, for the Movement. Read more about this in the [MArker Fixture topic](/grandma3/2-3/xyz_marker/).
