---
title: "Web Remote"
description: "The stations can be remote-controlled by any modern browser connected to the system. This includes Wi-Fi-connected devices."
product: grandma3
version: "2.3"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.3/HTML/network_webremote.html"
scrapedAt: "2026-06-15T18:25:19.089Z"
pagefind: false
---
...
Web remotes need to be enabled in the station. This can be done in the **Network Menu** - see the [Session topic](/grandma3/2-3/network_session/) to learn how to access this menu.

The network menu and [Station Control](/grandma3/2-3/network_station_control/) have a toggle button that turns the web remote On or Off.
...
![The image shows the Web Remote menu with a single connection.](/img/grandma3/2-3/menu_web-remote_v2-0-1c7021.png)
...
|                                                                    |                                    |
| ------------------------------------------------------------------ | ---------------------------------- |
| ![](/img/grandma3/2-3/icon_commandline-input_logo_v2-0-59d23e.png) | User name\[Fixture]>LogIn "Remote" |
...
![](/img/grandma3/2-3/img_command-line-input_link-command-line_v1-5-2ad9c3.png)
...
![](/img/grandma3/2-3/img_command-line-input_linked-command-line_example_v1-5-0e4a0d.png)
