---
title: "/NoSubfolders"
description: "To enter the /NoSubfolders option keyword in the command line, use one of the options:"
product: grandma3
version: "2.3"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.3/HTML/ok_nosubfolders.html"
scrapedAt: "2026-06-15T18:25:16.114Z"
pagefind: false
---
...
- [List keyword](/grandma3/2-3/keyword_list/)
...
|                                                                    |                                                    |
| ------------------------------------------------------------------ | -------------------------------------------------- |
| ![](/img/grandma3/2-3/icon_commandline-input_logo_v2-0-59d23e.png) | User name\[Fixture]>List ColorTheme /NoSubfolders  |
...
|                                                                    |                                                                                               |
| ------------------------------------------------------------------ | --------------------------------------------------------------------------------------------- |
| ![](/img/grandma3/2-3/icon_commandline-input_logo_v2-0-59d23e.png) | User name\[Fixture]>Import Macro Library "bestmacro.xml" At Macro 5 If Drive 2 /NoSubfolders  |
