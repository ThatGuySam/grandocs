...
version: "2.3"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.3/HTML/keyword_user.html"
scrapedAt: "2026-06-15T18:25:13.030Z"
pagefind: false
---
...
For more information on users and different settings see [User Setting](/grandma3/2-3/user_settings/).
...
The User keyword uses a number of settings. Change the settings using the [Set Keyword](/grandma3/2-3/keyword_set/). If a setting has to have a pool object, use the [Assign keyword](/grandma3/2-3/keyword_assign/) to assign an object to the setting.
...
|                                                                    |                                |
| ------------------------------------------------------------------ | ------------------------------ |
| ![](/img/grandma3/2-3/icon_commandline-input_logo_v2-0-59d23e.png) | User name\[Fixture]>List User  |
...
|                                                                    |                                 |
| ------------------------------------------------------------------ | ------------------------------- |
| ![](/img/grandma3/2-3/icon_commandline-input_logo_v2-0-59d23e.png) | User name\[Fixture]>User Admin  |

Alternatively see the [Login Keyword](/grandma3/2-3/keyword_login/).
...
|                                                                    |                                                    |
| ------------------------------------------------------------------ | -------------------------------------------------- |
| ![](/img/grandma3/2-3/icon_commandline-input_logo_v2-0-59d23e.png) | User name\[Fixture]>Assign Appearance 1 At User 2  |
...
|                                                                    |                                                            |
| ------------------------------------------------------------------ | ---------------------------------------------------------- |
| ![](/img/grandma3/2-3/icon_commandline-input_logo_v2-0-59d23e.png) | User name\[Fixture]>Set User "Remote" "Rights" "Playback"  |
