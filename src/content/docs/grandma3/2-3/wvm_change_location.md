---
title: "Change Menu Locations"
description: "Some menus can be moved between the screens."
product: grandma3
version: "2.3"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.3/HTML/wvm_change_location.html"
scrapedAt: "2026-06-15T18:25:18.180Z"
pagefind: false
---
...
![](/img/grandma3/2-3/img_display-icon-title-bar_v1-9-368c7f.png)

_Display icon next to the close X_

## Move a Menu to a Different Screen

**Requirement:**

- Open a menu that can be moved. For instance the [Playback Controls](/grandma3/2-3/ws_playback_controls/) Menu.

1. Tap the display icon in the title bar.\
   The **Edit Display Preference pop-up** appears:

![](/img/grandma3/2-3/popup_edit-display-preference_v1-9-a6240c.png)

_Use the Edit Display Preference pop-up to select a new location_
...
|                                            | Tap the Clear button or the ![](/img/grandma3/2-3/icon_cross_15px-ba31d0.png) to cancel the move.  |

## Move all Menus to a Screen

It is possible to select a screen where all moveable menus open.

1. Open the [Menu and Display pop-up](/grandma3/2-3/wvm_menus/).
