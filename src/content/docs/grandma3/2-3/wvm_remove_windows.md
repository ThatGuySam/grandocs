---
title: "Remove Windows from a Screen"
description: "There are three different ways to remove or delete a window from a screen: A single window can be deleted, all windows on a screen can be deleted, or all window"
product: grandma3
version: "2.3"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.3/HTML/wvm_remove_windows.html"
scrapedAt: "2026-06-15T18:25:18.007Z"
pagefind: false
---
...
This can be done using the command line or the GUI. This topic is about the GUI method. For information about the command method, please see the [Delete keyword](/grandma3/2-3/keyword_delete/) and the [ScreenContent keyword](/grandma3/2-3/keyword_screencontent/).
...
1. Open the Menu and Display pop-up by pressing the Menu key or tap the ![](/img/grandma3/2-3/icon_gear_15px-1dd78f.png) icon in the **[Control Bar](/grandma3/2-3/ws_ui_control_bar/)**.
