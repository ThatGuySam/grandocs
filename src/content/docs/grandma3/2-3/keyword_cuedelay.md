...
version: "2.3"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.3/HTML/keyword_cuedelay.html"
scrapedAt: "2026-06-15T18:24:59.089Z"
pagefind: false
---
To enter the CueDelay keyword in the command line, use one of the options:

- Press Time Time (If the Time Key Target is set to Cue. For more information see [User Settings](/grandma3/2-3/user_settings/) and [Time Key](/grandma3/2-3/key_time/).)
- Type **CueDelay**
...
For more information on how to set the delay times in objects see the [Delay Keyword](/grandma3/2-3/keyword_delay/).
...
|                                                                    |                                 |
| ------------------------------------------------------------------ | ------------------------------- |
| ![](/img/grandma3/2-3/icon_commandline-input_logo_v2-0-59d23e.png) | User name\[Fixture]>CueDelay 5  |
...
|                                                                    |                                    |
| ------------------------------------------------------------------ | ---------------------------------- |
| ![](/img/grandma3/2-3/icon_commandline-input_logo_v2-0-59d23e.png) | User name\[Fixture]>CueDelay 6/12  |
...
|                                                                    |                                 |
| ------------------------------------------------------------------ | ------------------------------- |
| ![](/img/grandma3/2-3/icon_commandline-input_logo_v2-0-59d23e.png) | User name\[Fixture]>CueDelay 3/ |
...
|                                                                    |                                             |
| ------------------------------------------------------------------ | ------------------------------------------- |
| ![](/img/grandma3/2-3/icon_commandline-input_logo_v2-0-59d23e.png) | User name\[Fixture]>Cue 1 Thru 4 CueDelay 5 |
