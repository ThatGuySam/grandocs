...
version: "2.3"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.3/HTML/network.html"
scrapedAt: "2026-06-15T18:25:18.634Z"
pagefind: false
---
...
A session is needed to connect grandMA3 devices. Read about [sessions here](/grandma3/2-3/network_session/).

## Ethernet DMX

grandMA3 can output DMX using Art-Net and sACN. It is possible to set up a specific Ethernet port to output the network DMX. Read more in the [DMX In and Out topics](/grandma3/2-3/dmx/).

## MVR-xchange

MVR-xchange can be used to exchange MVR information in a network. Learn more about this in the [MVR-xchange topic](/grandma3/2-3/remote_inputs_mvr/).
...
For more information, see the [World Server topic](/grandma3/2-3/system_world/) and the [Interfaces and IP topic](/grandma3/2-3/network_interface/).
...
Turning network On or Off is done from the **Network menu** - read about the network menu in the [Sessions topic](/grandma3/2-3/network_session/).

In the lower right corner of the network menu, there is a button to toggle the network connection.

![](/img/grandma3/2-3/icon_network-enable_v0-91-8a22df.png)
...
- [Session](/grandma3/2-3/network_session/)
- [Web Remote](/grandma3/2-3/network_webremote/)
- [Network Design](/grandma3/2-3/network_design/)
- [Regulations and Standards](/grandma3/2-3/network_regulations/)
- [Station Control](/grandma3/2-3/network_station_control/)
