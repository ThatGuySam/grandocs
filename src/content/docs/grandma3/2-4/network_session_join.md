...
version: "2.4"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.4/HTML/network_session_join.html"
scrapedAt: "2026-06-12T21:24:45.200Z"
---
**Requirement:**

Network connections need to be made, and the correct IP address should be set - For more information, see [Interfaces and IP](/grandma3/2-4/network_interface/). There needs to be a running session that can be joined.
...
![](/img/grandma3/2-4/popup_session-data-merge_v2-2-fba5cc.png)
...
|                                            | The default selected option and the timeout time can be adjusted in the Station Control menu. Learn more in the [Station Control topic](/grandma3/2-4/network_station_control/).  |
...
|                                                    | - Changes made to the patch during the disconnection of a station disable the possibility of merging.- Merging the deletion of parts of objects during the disconnection of a station is not fully working yet. (for example, deleting one macro line or deleting a recipe line)- Merging the movement of objects during the disconnection of a station creates duplicates: At the original spot and the new spot. This may result, for example, in having different sequences assigned to the same executor on different stations. |
...
![Warning about a joining High Priority station.](/img/grandma3/2-4/popup_warning-high-prio-station-join_v2-2-f4c3aa.png)
...
![Update this description text.](/img/grandma3/2-4/popup_warning-high-prio-station-invite_v2-2-c2b995.png)
...
1. Use the [JoinSession keyword]() to join an existing session or create a new one.
