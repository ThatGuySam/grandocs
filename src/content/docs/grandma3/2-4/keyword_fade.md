...
version: "2.4"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.4/HTML/keyword_fade.html"
scrapedAt: "2026-06-12T21:24:26.696Z"
---
To enter the **Fade** keyword in the command line, use one of the options:

- Press Time (If the Time Key Target is set to Fixture. For more information see [User Settings](/grandma3/2-4/user_settings/) and [Time Key](/grandma3/2-4/key_time/).)
- Press MA Time Time
- Type **Fade**
...
To set the fade times for cues, read more in the [CueFade keyword](/grandma3/2-4/keyword_cuefade/).
...
|                                                                    |                                       |
| ------------------------------------------------------------------ | ------------------------------------- |
| ![](/img/grandma3/2-4/icon_commandline-input_logo_v2-0-a59235.png) | User name\[Fixture]>Goto Cue 3 Fade 4 |
...
|                                                                    |                            |
| ------------------------------------------------------------------ | -------------------------- |
| ![](/img/grandma3/2-4/icon_commandline-input_logo_v2-0-a59235.png) | User name\[Fixture]>Fade 2 |
...
|                                                                    |                                  |
| ------------------------------------------------------------------ | -------------------------------- |
| ![](/img/grandma3/2-4/icon_commandline-input_logo_v2-0-a59235.png) | User name\[Fixture]>At 50 Fade 2 |
