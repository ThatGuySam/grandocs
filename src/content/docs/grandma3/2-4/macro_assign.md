...
version: "2.4"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.4/HTML/macro_assign.html"
scrapedAt: "2026-06-12T21:24:58.153Z"
---
The macros can be assigned to executors or view buttons for easy access. 

The macro is still in the macro pool. The executor or view button simply runs the macro in the pool. It is therefore required to have the macro in the pool before assigning it anywhere.
...
![](/img/grandma3/2-4/window_assign_menu-33051f.png)
...
|                                                                    |                                                                                                                                |
| ------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------ |
| ![](/img/grandma3/2-4/icon_commandline-input_logo_v2-0-a59235.png) | User name\[Fixture]>Assign Macro \["Macro\_Name" or Macro\_Number] At Page \["Page\_Name" or Page\_Number].\[Executor\_Number] |

To assign a macro to the current page, use this syntax:

|                                                                    |                                                                                                    |
| ------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------- |
| ![](/img/grandma3/2-4/icon_commandline-input_logo_v2-0-a59235.png) | User name\[Fixture]>Assign Macro \["Macro\_Name" or Macro\_Number] At Executor \[Executor\_Number] |
