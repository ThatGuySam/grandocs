...
version: "2.4"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.4/HTML/cue_mib.html"
scrapedAt: "2026-06-12T21:24:55.893Z"
---
...
It can also be applied using the [Hold Keyword](/grandma3/2-4/keyword_hold/).

While the MIB is in progress, the MIB indicator in the Fixture Sheet indicates this:

- **Fast flashing**: Fixtures' intensity fades to 0% in order to do an MIB.
...
If the fixture is selected and an absolute dimmer value above 0 is given, then there is a [User Profile Setting](/grandma3/2-4/user_settings/#h2_989550839) called **KnockIn MIB** defining what happens.
...
The sequence sheet can display several columns for the different MIB settings. Read more about the sequence sheet in the [Look at Cues and Preferences](/grandma3/2-4/cue_sequence_sheet/).
...
The property **MIB Transition** defines which transition type will be applied to the fade of MIB. Read more about the different types of transitions in the [Cue Timing topic](/grandma3/2-4/cue_timing/).
...
There are sequence-wide MIB settings within the sequence settings. Read more about the settings in the [Sequence Settings topic](/grandma3/2-4/cue_sequence_settings/).
...
![](/img/grandma3/2-4/img_mib-tracksheet_v2-1-eeb914.png)
...
The default color indicators are a deep-sea green background and black text color. Read more about the MIB colors in the fixture sheet and other grandMA3 colors in the [Colors topics](/grandma3/2-4/ws_colors/).
