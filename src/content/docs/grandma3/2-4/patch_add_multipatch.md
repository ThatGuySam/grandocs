...
![](/img/grandma3/2-4/img_live-patch_multi-patched-fixtures_v2-4-586591.png)
...
|                                            | The hidden multipatch CID should not be used to select the fixtures. The CID number will possibly change if changes are made to the patch. The number is not fixed. It is recommended to use the index number based on the primary fixture (the second example above).  |

Learn more about the keyword in the [Multipatch keyword](/grandma3/2-4/keyword_multipatch/) topic.
...
5. When all the needed information is assigned to the new multipatch fixtures, the patch menu can be closed by tapping ![](/img/grandma3/2-4/icon_cross_v0-1-191551.png) and saving the changes.
