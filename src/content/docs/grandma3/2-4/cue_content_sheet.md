...
version: "2.4"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.4/HTML/cue_content_sheet.html"
scrapedAt: "2026-06-12T21:24:54.408Z"
---
...
![](/img/grandma3/2-4/window_content-sheet_v2-1-561aa5.png)
...
The values displayed in the sheet can be edited directly in the sheet, just like in the Sequence Sheet in [Track sheet mode](/grandma3/2-4/cue_tracking/).

The look of the content sheet is very customizable. The content sheet settings control this. [Read more about it ](/grandma3/2-4/cue_content_sheet/#h2_948195719)[below](/grandma3/2-4/cue_content_sheet/#h2_948195719).
...
![](/img/grandma3/2-4/window_content-sheet_parts_v2-1-e39a9a.png)
...
![](/img/grandma3/2-4/window_content-sheet_manual_v2-3-81c23b.png)
...
- **Show Parts**:\
  This separates the cue parts into individual frames. Each frame can be turned On or Off by tapping the upper left corner of each frame. If this setting is Off, the cue parts are combined into one frame showing the cue part number in the lower right corner of each relevant attribute.
...
- **Fixture Select**:\
  With this On/Off button, fixtures can be selected by tapping the name or ID in the sheet.
...
Learn more about the Mask Buttons in the [Sheet Masking topic](/grandma3/2-4/worldfilter_filter_rules/).
