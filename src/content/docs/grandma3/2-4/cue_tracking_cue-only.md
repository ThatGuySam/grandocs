...
version: "2.4"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.4/HTML/cue_tracking_cue-only.html"
scrapedAt: "2026-06-12T21:24:53.652Z"
---
Cue Only is a [store option](/grandma3/2-4/cue_store_settings_preferences/) for cues. When stored in a cue with Cue Only, the tracked values will be blocked in the next cue or cue part to preserve the previous look on stage. The programmer's actual values will only be stored in the target cue or cue part.
...
- As command line option keyword [/CueOnly](/grandma3/2-4/ok_cueonly/) or /CO after the normal [Store keyword](/grandma3/2-4/keyword_store/).
...
![Update this description text.](/img/grandma3/2-4/img_cue-only_example-01_v2-1-eefd52.png)
