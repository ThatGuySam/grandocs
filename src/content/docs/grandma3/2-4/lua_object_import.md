...
version: "2.4"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.4/HTML/lua_object_import.html"
scrapedAt: "2026-06-12T21:25:07.729Z"
---
## Description
...
This example imports the content of an XML file into the selected sequence. The file is called "MySelectedSequence", and it is located at "../gma3\_library/datapools/sequences". The file can be created using the example in the [Export object function](/grandma3/2-4/lua_object_export/).
