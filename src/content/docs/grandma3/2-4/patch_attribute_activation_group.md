...
version: "2.4"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.4/HTML/patch_attribute_activation_group.html"
scrapedAt: "2026-06-12T21:24:47.661Z"
---
...
There are factory-defined groups that are used with the factory-defined attributes. Custom groups can be made and then used in the [Attribute Definitions](/grandma3/2-4/patch_attribute_definitions/). The group needs to be created before it can be used.

![](/img/grandma3/2-4/menu_patch_activation-groups_v2-4-433c78.png)
...
- **Deactivation Group**:\
  This column selects a **Deactivation Group** for two or more activation groups. Read more about this in the [Deactivation Group topic](/grandma3/2-4/patch_attribute_deactivation_group/).
...
For more information on how to use the **Activation Group** read the [Attribute Definition topic](/grandma3/2-4/patch_attribute_definitions/).
