...
version: "2.4"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.4/HTML/lua_objectfree_startprogress.html"
scrapedAt: "2026-06-12T21:25:06.446Z"
---
## Description
...
Executing the function displays the progress bar on the screens. It only disappears using the [StopProgress](/grandma3/2-4/lua_objectfree_stopprogress/) function - which needs the handle. So it is highly recommended to store the returned handle from the start function.
