...
version: "2.4"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.4/HTML/macro_import.html"
scrapedAt: "2026-06-12T21:24:58.074Z"
---
### Importing a Macro from the Macro Library

**Requirement:**

- Have a Macro Pool visible on one of the screens. For more information, see [Create Macros](/grandma3/2-4/macros/).
...
3. You can use the search function or scroll through the list to find a macro, select it, and then tap Import.
...
See the [Show Creator](/grandma3/2-4/show-creator/) menu for more information.

Predefined macros can be imported from the internal library, for example:
...
![](/img/grandma3/2-4/menu_import_macro_v2-1-60614f.png)
...
|                                            | If no pool object is selected, the macro will be imported at the next available empty pool object.  |
