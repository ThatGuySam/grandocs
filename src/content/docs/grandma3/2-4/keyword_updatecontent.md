...
version: "2.4"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.4/HTML/keyword_updatecontent.html"
scrapedAt: "2026-06-12T21:24:38.660Z"
---
...
2. Enter the media pool folder and then the image folder. \
   For more information see [ChangeDestination keyword](/grandma3/2-4/release_notes/). 
...
|                                                                    |                                                            |
| ------------------------------------------------------------------ | ---------------------------------------------------------- |
| ![](/img/grandma3/2-4/icon_commandline-input_logo_v2-0-a59235.png) | User name\@ShowData/MediaPools/Images>UpdateContent Image  |
