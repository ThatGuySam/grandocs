...
version: "2.4"
lang: en
sourceUrl: "https://help.malighting.com/grandMA3/2.4/HTML/qsg_add_moving.html"
scrapedAt: "2026-06-12T21:25:15.808Z"
---
In this chapter, we will return to the patch and add some moving lights.

We are going to add a variety of fixtures and hang them on our fictive fixture pods.
...
Let us start by checking the connection. The command line input bar displays a globe icon on the right-hand side when a connection to a world server is established.

![](/img/grandma3/2-4/qsg_11_world-server-globe_online_v2-3-5c3ff8.png)

A green globe indicates a good connection to the server. If this is true, you can jump to [Fixture Share Library](/grandma3/2-4/qsg_add_moving/#h2_1910645447) below. Keep reading to learn how to change the world server's address.
...
Click the ![](/img/grandma3/2-4/icon_gear_15_v1-9-bcb58d.png) (or press Menu) and click Network in the pop-up. This is the interesting part:

![](/img/grandma3/2-4/qsg_11_world-server_address_v1-8-591a4c.png)
...
Consoles need internet access on one of the Ethernet connectors on the back or using a mobile tether to connect to the server.
...
We need to get back into the Patch. You should remember how; otherwise, review [chapter 2](/grandma3/2-4/qsg_first_patch/).
...
We need to import new fixtures from a library, so click Library. The upper right corner of the pop-up has some buttons that can be used to select different library sections. The default is that the MA library (![](/img/grandma3/2-4/icon_ma-logo_15_v1-9-cb914b.png)) and the user created files (![](/img/grandma3/2-4/icon_user_15_v1-9-061460.png)) are active, but we can also activate the library section from the world server by turning On the globe icon ![](/img/grandma3/2-4/icon_world-server_15_v1-9-64e557.png).

![](/img/grandma3/2-4/qsg_11_library-selection_v1-9-37d1e4.png)
...
![](/img/grandma3/2-4/qsg_11_patch_x4-import_v2-3-f5ecc1.png)
...
![](/img/grandma3/2-4/qsg_11_insert-wizard_x4bar_v2-2-590311.png)
...
![](/img/grandma3/2-4/qsg_11_patch_megapointe-import_v2-3-ecf380.png)
...
![](/img/grandma3/2-4/qsg_11_insert-wizard_megapointe_v2-1-338a2f.png)
...
![](/img/grandma3/2-4/qsg_11_insert-wizard_auraxb_v2-1-976e9d.png)
...
![](/img/grandma3/2-4/qsg_11_insert-wizard_sharpy_v2-1-e15209.png)
...
![](/img/grandma3/2-4/qsg_11_3d_v2-2-8effb5.png)
...
![](/img/grandma3/2-4/qsg_11_groups-all_v2-2-f65625.png)
...
The [next chapter](/grandma3/2-4/qsg_control_moving/) is about controlling these fixtures.
