---
originalUrl: 'https://help2.malighting.com/Page/grandMA2/keyword_endif/en/3.9'
---
...
<option selected="selected" value="31">3.9</option>
	...
	<span class="pull-right" style="white-space: nowrap;">
			<button class="btn btn-mini" onclick="location.href='/Page/grandMA2/keyword_empty/en/3.9'; " title="Go to previous page 'Empty'">
				<i class="icon-arrow-left"></i> previous
			</button>

			<button class="btn btn-mini" onclick="location.href='/Page/grandMA2/keyword_endsession/en/3.9';" title="Go to next page 'EndSession'">
...
<div class="clear-fix" style="margin-bottom: 10px"></div>
			...
			<div class="pull-right">
					<button class="btn btn-mini" style="margin-right: 10px; height: 30px;" onclick="location.href = '/Media/TopicPdf/54569/31'; " title="Open/Save this topic as PDF document for viewing or printing">
...
<option selected="selected" value="31">3.9</option>
	...
	<div class="pull-right">
			...
			<button class="btn btn-mini" onclick="location.href='/Media/TopicPdf/54569/31';" title="Open/Save this topic as PDF document for viewing or printing">
