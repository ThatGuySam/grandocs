---
originalUrl: 'https://help2.malighting.com/Page/grandMA2/fys/en/3.3'
---
...
<option value="31">3.9</option>
	...
	<span class="pull-right" style="white-space: nowrap;">
			<button class="btn btn-mini" onclick="location.href='/Page/grandMA2/system/en/3.3'; " title="Go to previous page 'System requirements'">
				<i class="icon-arrow-left"></i> previous
			</button>

			<button class="btn btn-mini" onclick="location.href='/Page/grandMA2/functions-and-features/en/3.3';" title="Go to next page 'Functions and Features'">
...
<div class="clear-fix" style="margin-bottom: 10px"></div>
			...
			<div class="pull-right">
					<button class="btn btn-mini" style="margin-right: 10px; height: 30px;" onclick="location.href = '/Media/TopicPdf/23584/6'; " title="Open/Save this topic as PDF document for viewing or printing">
...
<option value="31">3.9</option>
	...
	<div class="pull-right">
			...
			<button class="btn btn-mini" onclick="location.href='/Media/TopicPdf/23584/6';" title="Open/Save this topic as PDF document for viewing or printing">
