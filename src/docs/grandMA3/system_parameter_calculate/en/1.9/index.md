---
originalUrl: 'https://help2.malighting.com/Page/grandMA3/system_parameter_calculate/en/1.9'
---
...
<option value="44">2.0</option>
	...
	<span class="pull-right" style="white-space: nowrap;">
			<button class="btn btn-mini" onclick="location.href='/Page/grandMA3/system_parameter/en/1.9'; " title="Go to previous page 'Parameters'">
				<i class="icon-arrow-left"></i> previous
			</button>

			<button class="btn btn-mini" onclick="location.href='/Page/grandMA3/system_parameter_expand/en/1.9';" title="Go to next page 'Expand the amount of parameters'">
...
<div class="clear-fix" style="margin-bottom: 10px"></div>
			...
			<div class="pull-right">
					<button class="btn btn-mini" style="margin-right: 10px; height: 30px;" onclick="location.href = '/Media/TopicPdf/87408/43'; " title="Open/Save this topic as PDF document for viewing or printing">
...
<p>Read the <a href="/Topic/db170ffd-acfa-47f2-a6d5-08bf3b336281">Expand the amount of parameters</a> topic to learn how to get more.</p>
...
<ul>
	...
	8 192 parameters.</li>
	<li><strong>grandMA3 compact XT:</strong><br>
	8 192 parameters.</li>
	...
	none parameters.</li>
	<li><strong>grandMA3 onPC rack-unit</strong>:<br>
	4 096 parameters.</li>
	...
	4 096 parameters (when connected to grandMA2 onPC this node provides only 1 024 parameters).</li>
	<li><strong>grandMA3 onPC 8Port Node DIN-Rail 4k</strong>:<br>
	4 096 parameters (when connected to grandMA2 onPC this node provides only 2 048 parameters).</li>
	<li><strong>grandMA3 onPC 4Port Node DIN-Rail 4k</strong>:<br>
	4 096 parameters (when connected to grandMA2 onPC this node provides only 2 048 parameters).</li>
	<li><strong>grandMA3 onPC 2Port Node DIN-Rail 2k</strong>:<br>
	4 096 parameters (when connected to grandMA2 onPC this node provides only 1 024 parameters).</li>
...
<option value="44">2.0</option>
	...
	<div class="pull-right">
			...
			<button class="btn btn-mini" onclick="location.href='/Media/TopicPdf/87408/43';" title="Open/Save this topic as PDF document for viewing or printing">
