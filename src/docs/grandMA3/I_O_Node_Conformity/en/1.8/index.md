---
originalUrl: 'https://help2.malighting.com/Page/grandMA3/I_O_Node_Conformity/en/1.8'
---
...
<option value="43">1.9</option>
	...
	<span class="pull-right" style="white-space: nowrap;">
			<button class="btn btn-mini" onclick="location.href='/Page/grandMA3/I_O_node_technical_data/en/1.8'; " title="Go to previous page 'Technical Data'">
				<i class="icon-arrow-left"></i> previous
			</button>

			<button class="btn btn-mini" onclick="location.href='/Page/grandMA3/grandMA3_Release_Notes/en/1.8';" title="Go to next page 'Release Notes'">
...
<option value="43">1.9</option>
	...
	<div class="pull-right">
			...
			<button class="btn btn-mini" onclick="location.href='/Media/TopicPdf/78260/42';" title="Open/Save this topic as PDF document for viewing or printing">
