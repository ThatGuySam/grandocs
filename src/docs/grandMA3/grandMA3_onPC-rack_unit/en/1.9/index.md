---
originalUrl: 'https://help2.malighting.com/Page/grandMA3/grandMA3_onPC-rack_unit/en/1.9'
---
...
<option value="44">2.0</option>
	...
	<span class="pull-right" style="white-space: nowrap;">
			<button class="btn btn-mini" onclick="location.href='/Page/grandMA3/rackunit_instances/en/1.9'; " title="Go to previous page 'Hardware-related Instances'">
				<i class="icon-arrow-left"></i> previous
			</button>

			<button class="btn btn-mini" onclick="location.href='/Page/grandMA3/grandMA3_Quick_Manual_viz_key/en/1.9';" title="Go to next page 'grandMA3 Quick Manual viz-key'">
...
<div class="clear-fix" style="margin-bottom: 10px"></div>
			...
			<div class="pull-right">
					<button class="btn btn-mini" style="margin-right: 10px; height: 30px;" onclick="location.href = '/Media/TopicPdf/82050/43'; " title="Open/Save this topic as PDF document for viewing or printing">
...
<option value="44">2.0</option>
	...
	<div class="pull-right">
			...
			<button class="btn btn-mini" onclick="location.href='/Media/TopicPdf/82050/43';" title="Open/Save this topic as PDF document for viewing or printing">
