---
originalUrl: 'https://help2.malighting.com/Page/grandMA3/grandMA3_onPC-rack_unit/en/1.8'
---
...
<option value="43">1.9</option>
	...
	<span class="pull-right" style="white-space: nowrap;">
			<button class="btn btn-mini" onclick="location.href='/Page/grandMA3/rack_unit_Technical_Data/en/1.8'; " title="Go to previous page 'Technical Data'">
				<i class="icon-arrow-left"></i> previous
			</button>

			<button class="btn btn-mini" onclick="location.href='/Page/grandMA3/grandMA3_Quick_Manual_viz_key/en/1.8';" title="Go to next page 'grandMA3 Quick Manual viz-key'">
...
<option value="43">1.9</option>
	...
	<div class="pull-right">
			...
			<button class="btn btn-mini" onclick="location.href='/Media/TopicPdf/78233/42';" title="Open/Save this topic as PDF document for viewing or printing">
