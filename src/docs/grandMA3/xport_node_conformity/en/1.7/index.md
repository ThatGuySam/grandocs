---
originalUrl: 'https://help2.malighting.com/Page/grandMA3/xport_node_conformity/en/1.7'
---
...
<option value="43">1.9</option>
	...
	<span class="pull-right" style="white-space: nowrap;">
			<button class="btn btn-mini" onclick="location.href='/Page/grandMA3/xport_nodes_technical_data/en/1.7'; " title="Go to previous page 'Technical Data'">
				<i class="icon-arrow-left"></i> previous
			</button>

			<button class="btn btn-mini" onclick="location.href='/Page/grandMA3/grandMA3_quick_manual_DIN-Rail/en/1.7';" title="Go to next page 'grandMA3 Quick Manual Nodes DIN-Rail'">
...
<div class="clear-fix" style="margin-bottom: 10px"></div>
			...
			<div class="pull-right">
					<button class="btn btn-mini" style="margin-right: 10px; height: 30px;" onclick="location.href = '/Media/TopicPdf/74479/40'; " title="Open/Save this topic as PDF document for viewing or printing">
...
<option value="43">1.9</option>
	...
	<div class="pull-right">
			...
			<button class="btn btn-mini" onclick="location.href='/Media/TopicPdf/74479/40';" title="Open/Save this topic as PDF document for viewing or printing">
