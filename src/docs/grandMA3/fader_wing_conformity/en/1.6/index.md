---
originalUrl: 'https://help2.malighting.com/Page/grandMA3/fader_wing_conformity/en/1.6'
---
...
<option value="44">2.0</option>
	...
	<span class="pull-right" style="white-space: nowrap;">
			<button class="btn btn-mini" onclick="location.href='/Page/grandMA3/Fader_wing_Technical_Data/en/1.6'; " title="Go to previous page 'Technical Data'">
				<i class="icon-arrow-left"></i> previous
			</button>

			<button class="btn btn-mini" onclick="location.href='/Page/grandMA3/grandMA3_onPC_rack_unit/en/1.6';" title="Go to next page 'grandMA3 Quick Manual onPC rack-unit'">
...
<div class="clear-fix" style="margin-bottom: 10px"></div>
					...
					<div class="infobox"><b>Hint:</b><br><b>New help version</b><br>The help version you selected belongs to an older software version. <a href="/Topic/SetCurrentVersionNumber/43/97f8e885-0f99-4e52-9f02-609faa26e47c">You may want to view the latest help version.</a></div>

			<div class="pull-right">
					<button class="btn btn-mini" style="margin-right: 10px; height: 30px;" onclick="location.href = '/Media/TopicPdf/71925/39'; " title="Open/Save this topic as PDF document for viewing or printing">
...
<p>Waldbüttelbrunn, July 28, 2020</p>

<p>Dipl.-Ing. Michael Adenau (CEO)</p>

<p><img alt="" src="/Media/Image/img_signature_m-adenau_5_1.png">&nbsp; &nbsp;&nbsp;<img alt="" src="/Media/Image/MA_Logo_120_3_1.png"></p>
...
<option value="44">2.0</option>
	...
	<div class="pull-right">
			...
			<button class="btn btn-mini" onclick="location.href='/Media/TopicPdf/71925/39';" title="Open/Save this topic as PDF document for viewing or printing">
