---
originalUrl: 'https://help2.malighting.com/Page/grandMA3/viz_key_Quick_Start/en/1.9'
---
...
<option value="44">2.0</option>
	...
	<span class="pull-right" style="white-space: nowrap;">
			<button class="btn btn-mini" onclick="location.href='/Page/grandMA3/viz_key_Limitations/en/1.9'; " title="Go to previous page 'Limitations'">
				<i class="icon-arrow-left"></i> previous
			</button>

			<button class="btn btn-mini" onclick="location.href='/Page/grandMA3/viz_key_Maintenance/en/1.9';" title="Go to next page 'Maintenance'">
...
<div class="clear-fix" style="margin-bottom: 10px"></div>
			...
			<div class="pull-right">
					<button class="btn btn-mini" style="margin-right: 10px; height: 30px;" onclick="location.href = '/Media/TopicPdf/82059/43'; " title="Open/Save this topic as PDF document for viewing or printing">
...
<option value="44">2.0</option>
	...
	<div class="pull-right">
			...
			<button class="btn btn-mini" onclick="location.href='/Media/TopicPdf/82059/43';" title="Open/Save this topic as PDF document for viewing or printing">
