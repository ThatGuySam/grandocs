---
originalUrl: 'https://help2.malighting.com/Page/MA_dot2/Key_Highlight/pt/1.1'
---
...
<option value="29">1.9</option>
	...
	<span class="pull-right" style="white-space: nowrap;">
			<button class="btn btn-mini" onclick="location.href='/Page/MA_dot2/Key_Help/pt/1.1'; " title="Go to previous page 'Help'">
				<i class="icon-arrow-left"></i> previous
			</button>

			<button class="btn btn-mini" onclick="location.href='/Page/MA_dot2/Key_Label/pt/1.1';" title="Go to next page 'Label'">
...
<div class="clear-fix" style="margin-bottom: 10px"></div>
			...
			<div class="pull-right">
					<button class="btn btn-mini" style="margin-right: 10px; height: 30px;" onclick="location.href = '/Media/TopicPdf/7271/3'; " title="Open/Save this topic as PDF document for viewing or printing">
...
<option value="29">1.9</option>
	...
	<div class="pull-right">
			...
			<button class="btn btn-mini" onclick="location.href='/Media/TopicPdf/7271/3';" title="Open/Save this topic as PDF document for viewing or printing">
